...
class FollowerTests {
    ...
    protected boolean testGetFollowers()
    {
      ...
      followerStore.addFollower(3,1,createDate("10/12/12 12:12"));
      int[] result = followerStore.getFollowers(2);
    ...
    {System.err.println("testGetTopUsers()");
      IFollowerStore followerStore = new FollowerStore();
    ...
    {System.err.println("testGetTopUsersFail()");
      IFollowerStore followerStore = new FollowerStore();
