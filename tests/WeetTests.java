...
class WeetTests {
    ...
    {
        System.err.println("-------- testAddWeet() --------");
    ...
    {
        System.err.println("-------- testAddWeetFail() --------");
        // Create new Weet Store
        IWeetStore weetStore = new WeetStore();
    ...
    {
        System.err.println("-------- testGetWeetSuccess() --------");
        // Create new Weet Store
        IWeetStore weetStore = new WeetStore();
    ...
    {
        System.err.println("-------- testGetWeetFail() --------");
        // Create new Weet Store
        IWeetStore weetStore = new WeetStore();
    ...
    {
      System.err.println("-------- testGetWeets() --------");
      IWeetStore weetStore = new WeetStore();
    ...
    {
      System.err.println("-------- testGetWeetsFail() --------");
      IWeetStore weetStore = new WeetStore();
      Weet[] results = weetStore.getWeets();
    ...
    {
      System.err.println("-------- testGetWeet(s)ByUser() --------");
      IWeetStore weetStore = new WeetStore();

      Weet weet1 = new Weet(1,1,"1,1",createDate("01/01/12 23:54"));
      Weet weet2 = new Weet(2,1,"2,1",createDate("01/01/12 23:57"));
      Weet weet3 = new Weet(3,1,"3,1",createDate("01/01/12 23:58"));
      Weet weet4 = new Weet(4,2,"4,2",createDate("01/01/12 23:59"));
      ...
      for (int i=0;i<results.length;i++)
      {
        System.err.println(results[i].getDateWeeted().toString() + " | ");
        if (results[i].getDateWeeted().compareTo(compare)>0)
        {
          System.out.print("[207]");
          return false;
        }
      }
      return true;
    ...
    {
      System.err.println("-------- testGetWeetByUserFail() --------");
      IWeetStore weetStore = new WeetStore();
    ...
    {
      System.err.println("-------- testGetWeetGetOn() --------");
      IWeetStore weetStore = new WeetStore();
      for (int i=9;i<=20;i++)
      {
      ...
      Weet[] toCheck = weetStore.getWeetsOn(createDate("11/11/11 10:32"));
      if (toCheck==null)
      {
        return false;
      }
    ...
    {
      System.err.println("-------- testGetWeetGetOnFail() --------");
      IWeetStore weetStore = new WeetStore();
      for (int i=9;i<=20;i++)
      {
        weetStore.addWeet(new Weet(i,1,"hi",createDate("12/11/11 12:20")));
    ...
    {
      System.err.println("-------- testGetWeetGetBefore() --------");
      IWeetStore weetStore = new WeetStore();
      for (int i=9;i<=20;i++)
      {
      ...
      Weet[] toCheck = weetStore.getWeetsBefore(weetArray[4].getDateWeeted());
      if (toCheck==null)
      {
        return false;
      }
      ...
      for (int j=0;j<toCheck.length;j++)
      {
        if (toCheck[j].getDateWeeted().compareTo(weetArray[4].getDateWeeted())>0)
        {
          return false;
        }
      }
    ...
    {
      System.err.println("-------- testWeetGetBeforeFail() --------");
      IWeetStore weetStore = new WeetStore();
      for (int i=9;i<=20;i++)
      {
        weetStore.addWeet(new Weet(i,1,"hi",createDate("11/11/"+(i+1)+" 12:20")));
    ...
    {
      System.err.println("-------- testGetWeetsContaining() --------");
      IWeetStore weetStore = new WeetStore();
    ...
    {
      System.err.println("-------- testGetWeetsContainingFail() --------");
      IWeetStore weetStore = new WeetStore();
      Weet weet1 = new Weet(1,1,"A new weet.",createDate("01/01/14 23:23"));
      Weet weet2 = new Weet(2,2,"A magical new weet.",createDate("01/01/14 23:25"));
      Weet weet3 = new Weet(3,3,"A lovely weet.",createDate("01/01/14 23:21"));
    ...
    {
      System.err.println("-------- testGetTrending() --------");
      IWeetStore weetStore = new WeetStore();
