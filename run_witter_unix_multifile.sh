...
cp -r $WORK_DIR/src/* $WORK_DIR/witter-tmp/WEB-INF/classes/uk/ac/warwick/java/cs126/services/
...
javac -classpath $WORK_DIR/witter-tmp/WEB-INF/classes/ uk/ac/warwick/java/cs126/services/UserStore.java &> $WORK_DIR/UserStore.log
javac -classpath $WORK_DIR/witter-tmp/WEB-INF/classes/ uk/ac/warwick/java/cs126/services/WeetStore.java &> $WORK_DIR/WeetStore.log
javac -classpath $WORK_DIR/witter-tmp/WEB-INF/classes/ uk/ac/warwick/java/cs126/services/FollowerStore.java &> $WORK_DIR/FollowerStore.log
